...
public class SellerReportController implements Injectable {
    ...
    private void showInfo(String title, String msg) {
        com.mycompany.ventacontrolfx.presentation.util.AlertUtil.showInfo(title, msg);
    }

    private void showError(String title, String msg) {
        com.mycompany.ventacontrolfx.presentation.util.AlertUtil.showError(title, msg);
    }
}
