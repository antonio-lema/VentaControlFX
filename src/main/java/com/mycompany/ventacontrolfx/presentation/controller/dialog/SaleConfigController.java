...
public class SaleConfigController implements Injectable {
    ...
    private SaleConfig buildConfig() {
        ...
        // Fiscal
        cfg.setTaxRate(21.0);
        cfg.setTaxType(container.getBundle().getString("tax.type.general"));
        cfg.setPricesIncludeTax(true);
        cfg.setCurrency(container.getBundle().getString("currency.euro"));
        cfg.setDecimals(container.getBundle().getString("decimals.two"));
