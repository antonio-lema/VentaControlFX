...
import com.mycompany.ventacontrolfx.presentation.controller.auth.RegisterUserController;
import com.mycompany.ventacontrolfx.presentation.component.SkeletonUserBox;
...
public class ManageUsersController implements Injectable {
    ...
    private void handleNewUser() {
        ...
        ModalService.showTransparentModal("/view/user/register_user.fxml",
