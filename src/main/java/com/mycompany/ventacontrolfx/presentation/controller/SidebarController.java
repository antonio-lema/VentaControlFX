...
public class SidebarController implements Injectable {
    ...
    private Button btnSell, btnProducts, btnCategories, btnHistory, btnReturns, btnClosures, btnBilling,
            btnClients, btnConfig, btnLock, btnThemeSettings, btnBackup, btnReports, btnClientReport, btnPriceLists,
            btnVat,
    ...
    public void inject(ServiceContainer container) {
        ...
        try {
            ...
            // Asegurar que el foco inicial no caiga en el bot\u00f3n de bloquear al final
            // del
            // VBox
            Platform.runLater(() -> {
                if (btnSell != null)
    ...
    private void applyVisualEffects() {
        Button[] btns = {
                ...
                btnConfig, btnThemeSettings, btnBackup, btnLock, btnPriceLists, btnVat,
    ...
    private void handleShowBackup() {
        ...
        navigationService.navigateTo("/view/backup_view.fxml");
    }

    // \u00e2\u201d\u20ac\u00e2\u201d\u20ac\u00e2\u201d\u20ac ACCIONES INFERIORES
