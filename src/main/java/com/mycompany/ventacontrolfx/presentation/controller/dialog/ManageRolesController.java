...
import com.mycompany.ventacontrolfx.presentation.component.SkeletonRoleBox;
...
public class ManageRolesController implements Injectable {
    ...
    private void handleNewRole() {
        ...
        ModalService.showTransparentModal("/view/user/edit_role.fxml", "Nuevo Rol", container, null);
    ...
    private void handleEditSingleRole(Role role) {
        ...
        ModalService.showTransparentModal("/view/user/edit_role.fxml", "Editar Rol", container,
