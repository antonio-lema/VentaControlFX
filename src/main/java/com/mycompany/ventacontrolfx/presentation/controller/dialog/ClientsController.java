...
import com.mycompany.ventacontrolfx.presentation.component.SkeletonClientBox;
...
public class ClientsController implements Injectable, com.mycompany.ventacontrolfx.presentation.util.Searchable {
    ...
    private void openClientForm(Client client) {
        ModalService.showTransparentModal("/view/dialog/client_form.fxml",
    ...
    private void handleClose() {
        if (closeAction != null) {
            ...
            container.getNavigationService().navigateTo("/view/cart/sell_view.fxml");
        }
    }
}
