package com.mycompany.ventacontrolfx.presentation.navigation;
...
public class ModalService {
    ...
    public static <T> T showModal(String fxmlPath, String title, Modality modality, StageStyle style,
        ...
        try {
            ...
            e.printStackTrace();
            AlertUtil.showError(container != null ? container.getBundle().getString("alert.error") : "Error", 
                               container != null ? container.getBundle().getString("error.modal_open") + ": " + title : "Could not open window: " + title);
            return null;
        }
    }
